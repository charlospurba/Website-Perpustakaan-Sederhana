...
@section('isihalaman')
    ...
    <h4>Perpustakaan USM</h4>
        Perpustakaan Institut Teknologi Del [IT Del] sebagai salah satu perpustakaan perguruan tinggi swasta di Indonesia 
		selama ini juga telah melaksanakan kelima tugas tersebut dalam kegiatan di perpustakaannya untuk mendukung 
		terwujudnya Tri Dharma Perguruan Tinggi. Berbagai upaya dilakukan oleh Perpustakaan institusi sendiri berada 
		...
		referensi lain guna menunjang proses pembelajaran di IT Del.

    <p>
        Perhatian pimpinan Yayasan dan institusi dalam pengembangan dan peningkatan layanan Perpustakaan semakin 
		membaik 5 tahun belakangan ini, hal ini ditunjukan dengan koleksi bahan perpustakaan yang meningkat cukup baik 
		ditiap tahunnya yaitu dengan rata-rata 5,18 % pertahun. Perpustakaan Institut Teknologi De sampai 10 Oktober 2024 
